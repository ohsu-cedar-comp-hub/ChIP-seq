...
OUT=$sdata/data/101_homerGenome/output                              # Directory where output files should be written
TODO=$sdata/todo/101_homerGenome.txt
MYBIN=$sdata/code/101_runHomerGenome.sh                      # Path to shell script or command-line executable that will be used
