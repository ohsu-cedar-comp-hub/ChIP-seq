...
#SBATCH --output             signalTrack_BDGCMP_%A_%a.out        # Standard output
#SBATCH --error              signalTrack_BDGCMP_%A_%a.err        # Standard error
...
OUT=$sdata/data/55_st_bdgcmp                       # Directory where output files should be written
