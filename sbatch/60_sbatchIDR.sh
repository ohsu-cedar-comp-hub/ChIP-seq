...
OUT=$sdata/data/60_idr
MYBIN=/home/exacloud/lustre1/BioCoders/Applications/anaconda2/envs/chip/bin/idr      # Path to shell script or command-line executable that will be used
